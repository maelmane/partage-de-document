...
CREATE DATABASE IF NOT EXISTS `partagedoc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `partagedoc`;
...
-- Dumping data for table partagedoc.users: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `documents` (
  ...
  `idUser` int(11),
  `auteur` varchar(100) COMMENT 'nom auteur',
  `nbLike` int(11) DEFAULT NULL,
  `statut` varchar(50) DEFAULT NULL COMMENT 'privé/protégé/public',
  PRIMARY KEY (`idDoc`),
  CONSTRAINT `FK_documents_users` FOREIGN KEY (`idUser`) REFERENCES `users`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table partagedoc.documents: ~3 rows (approximately)
INSERT INTO `documents` (`idDoc`, `titre`,`idUser`,`auteur`, `nbLike`, `statut`) VALUES
	(1, 'Exemple1.html',2, 'user1', 21, 'public'),
	(2, 'Exemple3.php',4, 'test2', 45, 'public'),
	(3, 'Devoir4.py',2, 'user1', 2, 'public');
